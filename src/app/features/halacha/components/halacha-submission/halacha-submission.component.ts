...
import { SummaryDisplayComponent, SummaryData } from '../../../../shared/components/summary-display/summary-display.component';
...
import { HalachaNumberExtractor } from '../../../../shared/utils/halacha-number-extractor';
...
import { WhatsAppFormatterService } from '../../../../shared/utils/whatsapp-formatter.service';
import { AnalysisLanguageService } from '../../../../core/services/analysis-language.service';
import { AnalysisLanguageSelectorComponent } from '../../../../shared/components/analysis-language-selector/analysis-language-selector.component';

@Component({
    selector: 'app-halacha-submission',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    templateUrl: './halacha-submission.component.html',
    styleUrls: ['./halacha-submission.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class HalachaSubmissionComponent {
